    ...
    {#if commentsHaveLoaded}
      {#each comments as { user, body, createdAt }}
        <div class="github-issue-comments__comment">
          ...
          <div class="github-issue-comments__comment-box">
            ...
            <div
              class="github-issue-comments__comment-box-body"
              use:removeEmailContent
            >
              {@html body.__html}
            </div>
          </div>
      ...
      {:else}
        <p class="github-issue-comments__no-comments-found">
          No comments found <span role="img" aria-label="Smiley Face Emoji">
            🙁
          </span>
        </p>
      {/each}
...
<style>
  ...
  .github-issue-comments__comment-box-header--is-owner {
    background-color: var(
      --github-issue-comments-header-owner-background-color
    );
  }
  ...
  .github-issue-comments__comment-box-body :global(blockquote) {
    ...
    border-left: 0.25em solid
      var(--github-issue-comments-blockquote-border-color);
  }
  ...
  .github-issue-comments__loading-icon {
    ...
    height: 40px;
    background-color: var(
      --github-issue-comments-loading-icon-background-color
    );
    margin: 0 auto;
    margin-top: 30px;
  ...
  .github-issue-comments__show-comments-button {
    ...
    padding-right: 8px;
    border: 1px solid
      var(--github-issue-comments-show-comments-button-text-color);
    border-radius: 3px;
    background-color: var(
